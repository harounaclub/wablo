                        ...
                        <div class="col-sm-6">
                            <div class="card" style="min-height: 500px">
                                <div class="card-header">
                                    <h2>Ajouter un ou plusieur(s) categorie(s) du personnel 
                                        <small>Employé, Maîtrise, Cadre...</small>
                                    </h2>
                                </div>
                                ...
                                <div class="zone-form">
                                    ...
                                    <div class="form-group input_fields_wrap">
                                     <h4>cocher un ou plusieurs categorie(s) proposee(s)</h4>
                                        ...
                                        if(isset($valeur_list_gen)){
                                          foreach($valeur_list_gen as $valeur_gen){ ?>
                                             ...
                                             <div class="checkbox m-b-15">
                                                <label>
                                                    <input type="checkbox" class="proposition" data-id="<?php echo $valeur_gen->libelle_cap;  ?>">
                                                    <i class="input-helper"></i>
                                                    <?php echo $valeur_gen->libelle_cap;  ?>
                                                </label>
                                             </div>
                                    ...
                                    <div id="zone_list_valeur">
                                        ...
                                        <?php
										 if(isset($valeur_list)){
										  ...
										  <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="<?php echo $infos->libelle_capp;  ?>" disabled></div>
											</div>
											<div class="col-sm-2">
												 <button class="btn btn-danger waves-effect supprim" data-id="<?php echo $infos->id_capp; ?>">x</button>
											</div>
                                        </div>
    ...
    $(document).ready(function() {
		  ...
		  if(compteur ==0){
				   ...
				   sweetAlert("Oops...", "Au moins une valeur d entreprise doit etre renseigne !", "error");
				    ...
				    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>administration/ajout_categorie_entreprise',
                        data: { 
		...
		$( ".supprim" ).on("click",function() {
			...
			$.ajax({
                        ...
                        url: '<?php echo base_url(); ?>administration/delete_categorie_ajax',
                        data: { 
							id_ajax: id_ajax, 	
						},
                        dataType: 'html',
        ...
        $( ".proposition" ).click(function() {
            ...
            $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>administration/ajout_categorie_individuel',
                        data: { 
							valeur: valeur, 
