...
class Valeur_model extends CI_Model {
	...
	function list_valeur(){
	  ...
	  function check_valeur($libelle_va){
           
		   $this->db->where('libelle_va', $libelle_va);
		   $q = $this->db->get('inov_valeur');
    ...
    function insert_valeur($data){			
        ...
        if($this->db->insert('inov_valeur',$data)){
            return true;
        }else{
            return false;
        }	
    ...
    function update_valeur($id,$data){
        ...
        if ($this->db->update('inov_valeur', $data)) {
            return true;
        } else {
            return false;
        }	
    ...
    function delete_valeur($id_liste_valeur){
        $this->db->where('id_va',$id_liste_valeur);
        $this->db->delete('inov_valeur');
		return true;
    } 
