                                    ...
                                    <div id="zone_list_valeur">
                                        ...
                                        <?php
										 if(isset($valeur_list)){
										  ...
										  <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="<?php echo $infos->libelle_va;  ?>" disabled></div>
											</div>
											<div class="col-sm-2">
												 <button class="btn btn-danger waves-effect supprim" data-id="<?php echo $infos->id_va; ?>">x</button>
											</div>
                                        </div>
    ...
    $(document).ready(function() {
				   ...
				   sweetAlert("Oops...", "Au moins une valeur d entreprise doit etre renseigne !", "error");
				    ...
				    $.ajax({
                        ...
                        success: function(json) {
							...
							$("#zone_list_valeur").load("<?php echo base_url('admin/valeur_list_ajax') ;?>"); 
		...
		$( ".supprim" ).on("click",function() {
			...
			$.ajax({
                        ...
                        url: '<?php echo base_url(); ?>admin/delete_valeur_ajax',
                        data: { 
							id_ajax: id_ajax, 	
						},
                        dataType: 'html',
