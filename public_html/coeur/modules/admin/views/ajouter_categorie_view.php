        ...
        ?> 
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card" style="min-height: 500px">
                                <div class="card-header">
                                    <h2>Ajouter une categorie du personnel
                                        <small>Vous pouvez ajouter une ou plusieurs categorie(s).</small>
                                    </h2>
                                </div>
                                ...
                                <div class="zone-form">
                                    ...
                                    <div class="form-group input_fields_wrap">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en1"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en2"></div>
											</div>
											<div class="col-sm-2">
                                         ...
                                         <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en3"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en4"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en5"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en6"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en7"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en8"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter categorie" id="valeur_en9"></div>
											</div>
											<div class="col-sm-2">
                       ...
                       <div class="col-sm-6">
                            <div class="card" style="min-height: 500px">
                                <div class="card-header">
                                    <h2>Listes des categories du personnel
                ...
                <div class="row">
                	...
                	<button class="btn btn-success waves-effect col-sm-4" id="ajouter">Ajouter une ou plusieurs categories(S)</button>
                </div>
                <div class="row">
                       <br>
                </div>
		  ...
		  if(compteur ==0){
				   ...
				   sweetAlert("Oops...", "Au moins une categorie d entreprise doit etre renseigne !", "error");
				    ...
				    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>admin/ajout_categorie_entreprise',
                        data: { 
							liste_categories_entreprise: list_val_en, 
