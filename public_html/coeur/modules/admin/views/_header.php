<head>
        ...
        <title>W@blo culture | administration</title>

        <!-- Vendor CSS -->
        <link href="<?php echo base_url(); ?>/assets/V2/vendors/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet">
        ...
        <link href="<?php echo base_url(); ?>/assets/V2/vendors/map/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>/assets/V2/vendors/flag-icons/css/flag-icon.min.css" rel="stylesheet">
        ...
        <link href="<?php echo base_url(); ?>/assets/V2/vendors/chosen/chosen.css" rel="stylesheet">
