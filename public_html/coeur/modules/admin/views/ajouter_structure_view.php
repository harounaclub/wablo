                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card" style="min-height: 500px">
                                <div class="card-header">
                                    <h2>Definisser la structure des entreprises
                                        <small>Vous pouvez ajouter une ou plusieurs structures.</small>
                                    </h2>
                                </div>
                                ...
                                <div class="zone-form">
                                    ...
                                    <div class="form-group input_fields_wrap">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en1"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en2"></div>
											</div>
											<div class="col-sm-2">
                                         ...
                                         <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en3"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en4"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en5"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en6"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en7"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en8"></div>
											</div>
											<div class="col-sm-2">
                                        ...
                                        <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="Ajouter un service ou un departement" id="valeur_en9"></div>
											</div>
											<div class="col-sm-2">
                       ...
                       <div class="col-sm-6">
                            <div class="card" style="min-height: 500px">
                                <div class="card-header">
                                    <h2>Listes des departements ou des services des entreprises
                                ...
                                <div class="zone-form">
                                    ...
                                    <div id="zone_list_valeur">
                                        ...
                                        <?php
										 if(isset($structure_list)){
                                             
											 
										  foreach($structure_list as $infos){ ?>
										  
										  <div class="row">
											<div class="col-sm-10">
												<div class="fg-line"><input type="text"  class="form-control input-sm" placeholder="<?php echo $infos->libelle_se;  ?>" disabled></div>
											</div>
											<div class="col-sm-2">
												 <button class="btn btn-danger waves-effect supprim" data-id="<?php echo $infos->id_se; ?>">x</button>
											</div>
                                        </div>
    ...
    $(document).ready(function() {
		...
		console.log(list_val_en);
		  ...
		  if(compteur ==0){
				   ...
				   sweetAlert("Oops...", "Au moins une categorie d entreprise doit etre renseigne !", "error");
				    ...
				    $.ajax({
                        ...
                        url: '<?php echo base_url(); ?>admin/ajout_structure_entreprise',
                        data: { 
							liste_structure_entreprise: list_val_en, 
                        ...
                        success: function(json) {
							...
							$("#zone_list_valeur").load("<?php echo base_url('admin/structure_list_ajax') ;?>"); 
		...
		$( ".supprim" ).on("click",function() {
			...
			$.ajax({
                        ...
                        url: '<?php echo base_url(); ?>admin/delete_structure_ajax',
                        data: { 
							id_ajax: id_ajax, 	
						},
                        dataType: 'html',
